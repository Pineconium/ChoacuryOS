...
ld -m elf_i386 -T src/linker.ld --allow-multiple-definition $BUILD/krnent.o $BUILD/drivinterrupt.o $BUILD/krnc.o $BUILD/drivkey.o $BUILD/drivport.o $BUILD/drivgdt.o $BUILD/drividt.o $BUILD/drivpic.o $BUILD/drivps2.o $BUILD/drivps2_keyboard.o $BUILD/drivps2_keymap_fi.o $BUILD/driv_utils.o $BUILD/driv_vga.o -o $BUILD/ChoacuryOS.bin -nostdlib
